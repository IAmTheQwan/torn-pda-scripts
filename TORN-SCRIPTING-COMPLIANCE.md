...
| Add All GOOD/STEAL | Add only currently visible listings whose player-initiated history analysis already produced an exact GOOD or STEAL result. This is a local list operation and performs no Torn request or game action. |
